...
def _get_permit_duration_days(cursor, permit_id):
    cursor.execute("""
...
def assign_permit_to_user(user_id, permit_id):
    ...
    try:
        days = _get_permit_duration_days(cursor, permit_id)
        ...
        """, (
            ...
            "active",
            "admin",
            "Assigned by admin permit manager.",
        ))
